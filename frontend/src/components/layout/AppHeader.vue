          ...
          <div class="relative" v-if="authStore.isAuthenticated">
            ...
            <transition name="scale">
              ...
              >
                ...
                <router-link v-if="authStore.isAdmin" to="/admin" class="flex items-center gap-2 px-4 py-2.5 text-sm text-primary-600 hover:bg-primary-50 font-medium transition-colors" @click="accountMenuOpen = false">
                  管理後台
                </router-link>
